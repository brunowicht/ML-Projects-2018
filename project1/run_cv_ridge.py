...
#    print(gamma)
#
#    w,mean_train_l,mean_test_l,train_error,test_error,std_train_l, std_test_l,std_train_e,std_test_e=cross_validation(ridge_regression,data_y,data_x,lambda_,initial_w,max_iters,gamma,proportion)
...
#df = pd.DataFrame([test_errors,train_errors])
#df.columns = np.linspace(1.6214285714285714e-06,3.8285714285714285e-06,5)
#df.index = ["Test Error","Train Error"]
